...
namespace DogVR.Actions
    ...
    public class TriggerStepBack : MonoBehaviour
        ...
        public string animationBoolTriggerName;
        public string animationParameterName;
        public int animationInt;
        public bool useAnimationParamamters;
        ...
        public void TriggerAnim()
            ...
            if (inRangeOfDog)
                ...
                if (animator != null && useAnimationParamamters)
                    {
                    animator.SetBool(animationBoolTriggerName, true); //animator.SetTrigger(animationToTrigger, true);
                    animator.SetInteger(animationParameterName, animationInt);
                    }
                else
                    {
