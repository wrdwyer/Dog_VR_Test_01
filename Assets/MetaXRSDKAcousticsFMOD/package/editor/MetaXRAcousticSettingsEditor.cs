...
class MetaXRAcousticSettingsProvider : SettingsProvider
{
    ...
    public override void OnGUI(string searchContext)
    {
        ...
        EditorGUILayout.PropertyField(serializableSettings.FindProperty("dynamicSimulationEnabled"), new GUIContent("Dynamic Simulation"));
        EditorGUI.BeginDisabledGroup(!settings.DynamicSimulationEnabled);
        EditorGUILayout.PropertyField(serializableSettings.FindProperty("dynamicQuality"), new GUIContent("Dynamic Quality"));
        EditorGUILayout.PropertyField(serializableSettings.FindProperty("dynamicDiffractionOrder"), new GUIContent("Dynamic Diffraction Order"));
